...
## Project Structure
    ...
    ├── solitary_snowflake_30888  # Django project configurations
...
1. Clone this repo and `cd solitary_snowflake_30888`
...
2. Clone this repo and `cd solitary_snowflake_30888`
